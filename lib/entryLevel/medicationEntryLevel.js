...
exports.medicationActivity = {
  ...
  content: [
    ...
    },
    {
      ...
      content: [[medicationDispense, required]],
      dataKey: 'dispense'
    },
    {
      key: 'precondition',
      ...
      content: [
        ...
        [sharedEntryLevel.preconditionForSubstanceAdministration, required]
      ],
      dataKey: 'precondition',
      warning:
        'templateId needs to be in preconditionForSubstanceAdministration but CCD_1.xml contradicts'
    }
  ],
  notImplemented: [
    'code',
